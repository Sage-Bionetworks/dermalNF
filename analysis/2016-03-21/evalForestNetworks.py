...
syn.store(synapseclient.File('forestStats.txt',parentId='syn5804586'),activityName='evaluatedForestAndParams',used = {'url':'https://raw.githubusercontent.com/Sage-Bionetworks/dermalNF/master/analysis/2016-03-21/evalForestNetworks.py'})
