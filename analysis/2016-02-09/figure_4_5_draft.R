...
png('violinPlotOfLogNormDeseqCounts.png',width=800)
print(p)
dev.off()
...
png('boxPlotOfLogNormMinCount2DeseqCounts.png',width=800)
print(p)
dev.off()
...
png('violinPlotOfSizeFactorNormDeseqCounts.png',width=800)
print(p)
dev.off()
...
png('violinPlotOfLogSizeFactorNormDeseqCounts.png',width=800)
print(p)
dev.off()
...
png('boxPlotOfSizeFactorNormDeseqCounts.png',width=800)
print(p)
dev.off()

res$NormCounts=log2(res$NormCounts+1)
p<-ggplot(res,aes(y=NormCounts,x=Sample))+geom_boxplot(aes(fill=Patient))+geom_point(data=subset(res,Gene == 'NF1'),shape=4)
png('boxPlotOfLogSizeFactorNormMinCount2DeseqCounts.png',width=800)
print(p)
dev.off()
...
png('violinPlotOfFpkm.png',width=800)
print(p)
dev.off()
...
png('boxPlotOfFpkmMin0.1.png',width=800)
print(p)
dev.off()
...
png('boxPlotOfProteins.png',width=800)
print(p)
dev.off()

p<-ggplot(pres,aes(y=FoldChange,x=Sample))+geom_violine(aes(fill=Patient))+scale_y_log10()
png('violinPlotOfProteins.png',width=800)
print(p)
dev.off()
