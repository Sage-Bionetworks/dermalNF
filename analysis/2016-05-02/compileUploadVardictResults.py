...
#        outfile='patient_%s_tumor_%s_vs_normal_%s.snp'%(p,tu,normind[0])
        ...
        vcf = compileVcfs('/mnt/huge/dermalWgs/varDict/'+normsamp+'_'+tumsamp+'.snpeff.vcf','20')
        maffile = makeMafFromVcf(vcf)
