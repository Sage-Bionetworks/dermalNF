...
olheader=open('../2015-12-07/headerFile.txt','r').readlines()
...
newcmd='bcftools reheader ../2015-12-07/geneRegionsWH.vcf -h newHeaderFile.txt -o geneRegionsOnlyWithSampleNames.vcf'
print newcmd
os.system(newcmd)
